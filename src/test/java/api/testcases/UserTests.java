...
public class UserTests {
	...
	public void testGetValidUser() {
		...
		Response response = UserEndPoints.getUser(this.up.getUsername());
	...
	public void testGetInValidUser() {
		...
		Response response = UserEndPoints.getUser("Fakeuser");
	...
	public void testUpdateUser() {
		...
		up.setFirstName(faker.name().firstName());
		Response response = UserEndPoints.updateUser(this.up, up.getUsername());
		...
		//Assertion  Validating Response Code
		AssertJUnit.assertEquals(response.getStatusCode(),200);
		Response responseafterUpdate = UserEndPoints.getUser(this.up.getUsername());
	...
	public void testDeleteUser() {
		...
		Response response = UserEndPoints.deleteUser(this.up.getUsername());
